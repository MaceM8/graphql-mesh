...
- [#4689](https://github.com/Urigo/graphql-mesh/pull/4689)
  ...
  - Removed dependency
    [`@udacity/types-service-worker-mock@1.2.0` ↗︎](https://www.npmjs.com/package/@udacity/types-service-worker-mock/v/1.2.0)
    (from `dependencies`)
  - Removed dependency
    [`cloudflare-worker-mock@1.2.0` ↗︎](https://www.npmjs.com/package/cloudflare-worker-mock/v/1.2.0)
    (from `dependencies`)
